...
class Basic:
    ...
    def fit(self, data):
        ...
        self.y_pred = self.y_train.sum()/len(self.y_train)
    ...
    def score(self):
        return self.log_loss_score(self.y_test, self.predict_proba(self.X_test))
    ...
    def predict_proba(self, df):
        return np.array([self.y_pred]*self.X_test.shape[0])
